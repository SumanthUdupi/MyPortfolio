...
export const caseStudies: { [key: string]: CaseStudy } = {
  ...
  'pokedex-app': {
    ...
    imageUrl: 'public/images/pokedex-app.gif',
  ...
  'auto-dashboard': {
    id: 'auto-dashboard',
    title: 'Project Vroom',
    hook: '0 to 60 in 4.2 seconds (of data loading). A real-time auto dashboard.',
    imageUrl: 'public/images/auto-dashboard-sweep.gif',
