...
const Hero = () => {
  ...
  return (
    <section id="hero" className="mb-24 md:mb-32" ref={sectionRef}>
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
        <div className="w-full md:w-2/3">
          <h1 className="font-kalam text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 dark:text-stone-100 fade-in-up" ref={h1Ref}>
            I turn complex ESG & EHS challenges into elegant, human-centered solutions.
          </h1>
          <p className="font-mono text-base md:text-lg text-stone-600 dark:text-stone-400 fade-in-up" ref={pRef} data-animation-delay="200ms">
